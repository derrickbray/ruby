...
class UniversesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create universe" do
    assert_difference('Universe.count') do
      post universes_url, params: { universe: { author: @universe.author, description: @universe.description, title: @universe.title } }
    end
  ...
  test "should update universe" do
    patch universe_url(@universe), params: { universe: { author: @universe.author, description: @universe.description, title: @universe.title } }
